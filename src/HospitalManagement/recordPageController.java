...
public class recordPageController implements Initializable {
    ...
    @FXML
    private TableColumn<PatientData, String> recordpage_col_dateModified; // correct spelling
    ...
    public ObservableList<PatientData> getPatientRecordData() {
        ...
        // RESTART RECORD PAGEFORM FXML IF YOU DIDNT SEE THE RECORDPAGEFORMCONTROLLER
        // CLASS
    ...
    public void actionButtons() {
        ...
        Callback<TableColumn<PatientData, String>, TableCell<PatientData, String>> cellFactory = (
                TableColumn<PatientData, String> param) -> {
                        ...
                        removeButton.setOnAction((ActionEvent event) -> {
                            ...
                            try {
                                if (alert.confirmationMessage(
                                        "Are you sure you want to delete Patient ID: " + pData.getPatientID() + "?")) {
